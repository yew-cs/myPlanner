...
<html lang="en">
  <head>
    ...
    <title>Planner || Add course</title>
            ...
            <div class="row mt">
              <div class="col-lg-12">
                <div class="form-panel">
                  ...
                  <form class="form-horizontal style-form" name="form2" onSubmit="return validateForm2()" method="POST">
                   <!--  <div class="form-group "">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="subcode" placeholder="Eg. CMPD334"   pattern="[A-Za-z0-9]{4,8}" title="4 to 8 Alphanumeric long with no space" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 col-sm-2 control-label">Subject Name</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="subname" placeholder="Eg. Fundamentals of Software Engineering" required/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="lecturer" placeholder="Eg. Lady Gaga" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-lg-12" >
                        ...
                        <button type="submit" class="btn btn-success" name="add_course" ><span class="fa fa-save"></span> Save </button></center>
                      </div>
                    </form>
                    <?php
                 ...
                 $sql1= "INSERT INTO course(subcode,subname,lecturer,uid) VALUES('$subcode','$subname','$lecturer','$uid') ";
                     if ($con->query($sql1) === TRUE) {                   
                                    
                    echo '<script> window.alert("Course Added."); window.location.href="viewCourse.php"</script>';
                    } else {
