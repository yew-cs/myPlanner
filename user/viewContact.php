...
<html lang="en">
  <head>
    ...
    <title>Planner || View Contacts</title>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
              ...
              <li class="sub-menu">
                ...
                <ul class="sub">
                  ...
                  <li  class="active"  ><a  href="viewContact.php">View</a></li>
                </ul>
              </li>
              <li class="sub-menu">
                ...
                <div class="content-panel">
                  <table id="example" class="table table-striped table-hover" cellspacing="100" width="98%">
                    ...
                    <tbody>
                      <?php
                      $count=1;
                      $res = mysqli_query($con,"SELECT * FROM persons WHERE uid='".$_SESSION['uid']."'");
                      ...
                      <div class="modal fade" id="edit<?php echo $id; ?>"tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                              <center><h4 class="modal-title" id="myModalLabel1"><b>Update Contact</b></h4></center>
                            </div>
                            <div class="modal-body">
                              <div class="container-fluid">
                                <form method="POST" id="form2" name="form2" onsubmit="return validateForm2()">
                                  ...
                                  <div class="form-group input-group">
                                    <span class="input-group-addon" style="width:150px;">Contact Name:</span>
                                    <input type="text" style="width:420px;" class="form-control" name="name" value="<?php echo $name; ?>" required autofocus />
                                  </div>
                                  
                                  <div class="form-group input-group">
                                    <span class="input-group-addon" style="width:150px;">Contact Email:</span>
                                    <input type="text" style="width:420px;" class="form-control" name="email2" value="<?php echo $email; ?>" required autofocus/>
                                  </div>
                                  
                                  <div class="form-group input-group">
                                    <span class="input-group-addon" style="width:150px;">Contact Mobile:</span>
                                    <input type="text" style="width:420px;" class="form-control" name="mobile2" value="<?php echo $mobile; ?>" required >
                                  </div>
                                  
                                  <div class="form-group input-group">
                                    <span class="input-group-addon" style="width:130px;">Address:</span>
                                    <textarea cclass="form-control" id="address" name="address" placeholder="Description" required style="width: 100%;"><?php echo $address; ?></textarea>
                                  </div>
                    ...
                    <script>window.alert("Updated successfully."); window.location.href = "viewContact.php";</script>
                    <?php
                    } else {
                    ...
                    if ($con->query($sql) === TRUE) {
                    $sql = "DELETE FROM persons WHERE id='$delete_id' ";
                    echo '<script> window.alert("Deleted."); window.location.href="viewContact.php"</script>';
                    } else {
